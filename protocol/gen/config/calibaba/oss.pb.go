...
var file_config_calibaba_oss_proto_rawDesc = []byte{
...
var (
	...
	file_config_calibaba_oss_proto_rawDescData = file_config_calibaba_oss_proto_rawDesc
)

func file_config_calibaba_oss_proto_rawDescGZIP() []byte {
	file_config_calibaba_oss_proto_rawDescOnce.Do(func() {
		file_config_calibaba_oss_proto_rawDescData = protoimpl.X.CompressGZIP(file_config_calibaba_oss_proto_rawDescData)
	})
...
func file_config_calibaba_oss_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_config_calibaba_oss_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_config_calibaba_oss_proto_rawDesc = nil
