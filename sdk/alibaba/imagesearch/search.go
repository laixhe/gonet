...
func (isc *ISClient) SearchByPic(req *clientv4.SearchImageByPicAdvanceRequest,
	runtimeObjects ...*service.RuntimeOptions) ([]*clientv4.SearchImageByPicResponseBodyAuctions, error) {
	/*
	...
	*/
	var runtimeObject = new(service.RuntimeOptions)
