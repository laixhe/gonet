...
// Put 简单上传
func (oc *OClient) Put(ctx context.Context, objectName string, body io.Reader, contentType string, acls ...ossv2.ObjectACLType) error {
...
// PutFile 简单上传文件
func (oc *OClient) PutFile(ctx context.Context, objectName string, localFile string, contentType string, acls ...ossv2.ObjectACLType) error {
	request := &ossv2.PutObjectRequest{
		Bucket: ossv2.Ptr(oc.config.Bucket), // 存储空间名称
		Key:    ossv2.Ptr(objectName),       // 对象名称
	}
